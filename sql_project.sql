...
-- creating database to store the tables at one stuctured place
show DATABASES;
use sales;
...
-- Stuctures of the tables created
...
-- The average order quantity is 1.8889